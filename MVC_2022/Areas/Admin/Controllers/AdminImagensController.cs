...
namespace MVC_2022.Areas.Admin.Controllers
{
    ...
    public class AdminImagensController : Controller
    {
        ...
        //Forcenece informações do ambiente na qual a aplicação está rodando.
        ...
        public async Task<IActionResult> UploadFiles(List<IFormFile> files)
        {
            ...
            //Soma a quantidade em bytes de todos os arquivos dentro da lista files.
            long size = files.Sum(f => f.Length);

            var filePathsName = new List<string>();

            //Cria caminho completo onde o arquivo será armazenado.
